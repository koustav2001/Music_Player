...
class Player(tk.Frame):
    ...
    def track_widgets(self):
        ...
        self.songtrack['text'] = 'Goriber MP3 Player'
...
if __name__ == '__main__':
    ...
    root.title('Goriber Mp3 Player')

    img = PhotoImage(file='E:/images/music.gif')
    next_ = PhotoImage(file='E:/images/next.gif')
    prev = PhotoImage(file='E:/images/previous.gif')
    play = PhotoImage(file='E:/images/play.gif')
    pause = PhotoImage(file='E:/images/pause.gif')
